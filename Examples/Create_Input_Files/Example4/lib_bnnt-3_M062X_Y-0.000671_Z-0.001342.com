...
%chk=lib_bnnt-3_M062X_Y-0.000671_Z-0.001342.chk
#P M062X/gen
...
SCF(XQC,Conver=11,MaxCycles=300) Integral(Grid=fine,Acc2E=14,NoXCTest,NoXCTest,NoXCTest,NoXCTest)
IOp(3/33=5) polar
IOp(3/14=-6)
