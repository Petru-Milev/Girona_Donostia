%nproc=8
%mem=24Gb
%oldchk=lib_bnnt-3_M062X_Example_6_kw_changed_delete_XQC_Z+0.002000.chk
%chk=lib_bnnt-3_M062X_Example_6_kw_changed_delete_XQC_Z+0.002500.chk
#P M062X
Symmetry(PG=C4v,SaveOrientation,axis=z)
geom=check  ChkBasis guess=(read) IOp(9/75=2)
